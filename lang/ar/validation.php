...
return [
    ...
    'attributes' => [
        ...
        'roles' => 'الدور',
        'name.ar' => 'العنوان باللغة العربية',
        'name.en' => 'العنوان باللغة الانكليزية',
        'title.en' => 'العنوان باللغة الانكليزية',
        'title.ar' => 'العنوان باللغة العربية',
        'short_description.ar' => 'وصف قصير باللغة العربية',
        'short_description.en' => 'وصف قصير باللغة الانكليزية',
        'description.ar' => 'الوصف باللغة العربية',
        'description.en' => 'الوصف باللغة الانكليزية',
        'meta_keywords.ar' => 'كلمات مفتاحية باللغة العربية',
        'meta_keywords.en' => 'كلمات مفتاحية باللغة الانكليزية',
        'tag_id' => 'الوسوم',
