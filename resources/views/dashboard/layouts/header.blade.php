                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{asset('media/svg/brand-logos/volicity-9.svg')}}" alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{asset('media/svg/brand-logos/tvit.svg')}}" alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{asset('media/svg/misc/infography.svg')}}" alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{asset('media/svg/brand-logos/leaf.svg')}}" alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{asset('media/svg/brand-logos/tower.svg')}}" alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="mb-5">
                                    <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                                        ...
                                        data-select2-id="select2-data-1-382w" tabindex="-1" aria-hidden="true"
                                        data-kt-initialized="1">
                                        <option value="next" data-select2-id="select2-data-3-vxrn">Within the next
                                        </option>
                                        <option value="last">Within the last</option>
                                        <option value="between">Between</option>
                                        <option value="on">On</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap5"
                                        dir="ltr" data-select2-id="select2-data-2-u1rw" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-timezone-yv-container"
                                                aria-controls="select2-timezone-yv-container"><span
                                                    class="select2-selection__rendered"
                                                    id="select2-timezone-yv-container" role="textbox"
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-6">
                                        <select name="date_typer" aria-label="Select a Timezone" data-control="select2"
                                            ...
                                            class="form-select form-select-sm form-select-solid select2-hidden-accessible"
                                            data-select2-id="select2-data-4-cqwh" tabindex="-1" aria-hidden="true"
                                            data-kt-initialized="1">
                                            <option value="days" data-select2-id="select2-data-6-mvw2">Days</option>
                                            <option value="weeks">Weeks</option>
                                            <option value="months">Months</option>
                                            <option value="years">Years</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5"
                                            dir="ltr" data-select2-id="select2-data-5-astt" style="width: 100%;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-date_typer-b6-container"
                                                    aria-controls="select2-date_typer-b6-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-date_typer-b6-container" role="textbox"
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                            src="{{asset('media/illustrations/sketchy-1/1.png')}}">
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                ...
                                                <img src="{{asset('media/svg/brand-logos/amazon.svg')}}"
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/angular-icon-1.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/atica.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/beats-electronics.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/codeigniter.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/bootstrap-4.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/google-tag-manager.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/disqus.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/dribbble-icon-1.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/google-play-store.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/google-podcasts.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/github.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/gitlab.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{asset('media/svg/brand-logos/pinterest-p.svg')}}"
                                                    class="w-25px h-25px mb-2" alt="">
                                ...
                                <span class="menu-title position-relative">
                                    <span
                                        ...
                                        @if (App::getLocale() == 'ar')
                                            ...
                                            <img class="rounded-1" src=" {{ URL::asset('media/flags/syria.svg') }} " alt="">
                                        @else
                                            {{ LaravelLocalization::getCurrentLocaleName() }}
                                            <img class="rounded-1" src="{{ URL::asset('media/flags/united-states.svg') }}"
                                                alt="">
                                        @endif
                                    </span></span>
                            </a>
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                                ...
                                                <span class="symbol symbol-20px me-4">
                                                    @if (App::getLocale() == 'ar')
                                                        {{ LaravelLocalization::getCurrentLocaleName() }}
                                                        <img class="rounded-1" src=" {{ URL::asset('media/flags/syria.svg') }} "
                                                            alt="">
                                                    @else
                                                        {{ LaravelLocalization::getCurrentLocaleName() }}
                                                        <img class="rounded-1"
                                                            src="{{ URL::asset('media/flags/united-states.svg') }}" alt="">
                                                    @endif
